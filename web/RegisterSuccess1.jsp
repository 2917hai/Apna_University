        ...
        <div class="main1">
            ...
            <center>
                ...
                <div style="position: absolute;" class="susseccMessege">
                    ...
                    <h3>This is Your Employee ID generated By Apana University</h3>
                    <h1 style="color: darkmagenta;">Your EmpId: <span style="color: red; text-decoration: underline;"> <%=newFacultyId%></span></h1>
                    <h4>Thank You...!</h4> <br><br>

                    <a href="facultyLogin.html">Login Your Profile</a>
                </div>
