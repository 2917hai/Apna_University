...
<html lang="en">
    ...
    <body style="background-color: antiquewhite">
        ...
        <div class="main1">
            <div style="position: absolute;   width: 100%;" class="img">
                <img style="width: 100%; height: 700px; opacity: 25%; position: relative;" src="images/first.jpg" alt="">
            </div>
            <%
                StudentsRegisterDAO sd = new StudentsRegisterDAO();
                String prefix = "APANA";
                String enroll = sd.getEnroll();
                String numPart = enroll.replace(prefix, "");
                int nextNo = Integer.parseInt(numPart) - 1;
                String newEnrollment = prefix + nextNo;
                ...
                <script>
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            document.querySelector('.susseccMessege').style.display = 'block';
                        }
                    });
                </script>
                <div style="position: absolute;" class="susseccMessege">
                    <h1 style="color: blue;">Congratulation You have SuccessFully Registered...!</h1>
                    <h3>This is Your Enrollment No generated By Apana University</h3>
                    <h1 style="color: darkmagenta;">Your Enrollment: <span style="color: red; text-decoration: underline;"> <%=newEnrollment%></span></h1>
                    <h4>Thank You...!</h4> <br><br>

                    <a href="StudentsLogin.html">Login Your Profile</a>
                </div>
