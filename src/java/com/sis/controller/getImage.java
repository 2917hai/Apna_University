...
public class getImage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String enroll = request.getParameter("enroll"); // किस student का data चाहिए
        String type = request.getParameter("type");     // कौन सा image चाहिए (photo/sign/aadhar ...)

        StudentsRegisterDAO dao = new StudentsRegisterDAO();
        StudentsBean sb = dao.StudentProfile(enroll);
        ...
        if ("photo".equals(type)) {
            ...
            imgData = sb.getAadhar();
        } else if ("cast".equals(type)) {
            imgData = sb.getCast();
        } else if ("income".equals(type)) {
            imgData = sb.getIncome();
        } else if ("domicile".equals(type)) {
            imgData = sb.getDomicile();
        } else if ("latestQualification".equals(type)) {
            imgData = sb.getLatestQualification();
        }
